...
export default function AlbumsPage() {
  ...
  return (
    <section className="py-10 max-w-[1400px] mx-auto px-4">
      <h1 className="text-4xl font-bold mb-10 text-center">Albums</h1>
          ...
          >
            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-black/40 backdrop-blur-sm">
              <img
                src={a.cover}
                alt={a.name}
                className="w-full h-64 object-cover rounded-2xl transition duration-300 group-hover:scale-105 group-hover:brightness-110"
              />
            </div>
